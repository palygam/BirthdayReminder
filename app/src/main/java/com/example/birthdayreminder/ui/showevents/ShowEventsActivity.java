...
import com.example.birthdayreminder.ui.newevent.ScreenType;
...
public class ShowEventsActivity extends BaseActivity implements ShowEventsActivityView {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.add_new_notification_menu:
                presenter.onMenuClicked(ShowEventsActivity.this, NewEventActivity.class, ScreenType.ADD_SCREEN);
                return true;
            case R.id.settings:
                presenter.onMenuClicked(ShowEventsActivity.this, SetSettingsActivity.class, ScreenType.DEFAULT);
            default:
    ...
    public void initRecyclerView() {
        ...
        adapter.SetOnItemClickListener(new OnItemClickListener() {
            ...
            public void onClick(View itemView, int position) {
                ...
                presenter.onClickRecyclerView(ShowEventsActivity.this, NewEventActivity.class, event, ScreenType.EDIT_SCREEN);
            }

            @Override
            public void onLongClick(View itemView, int position) {
                MaterialAlertDialogBuilder alert = new MaterialAlertDialogBuilder(ShowEventsActivity.this, R.style.AlertDialog);
    ...
    @Override
    public void launchNewActivity(Context context, Class nextActivity, Event event, Enum screenType) {
        ...
        intent.putExtra(Constants.SCREEN_TYPE, screenType);
